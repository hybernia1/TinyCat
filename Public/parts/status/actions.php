...
<div class="status-reactions">
    ...
    <?php if ($openCommentsModal): ?>
        <a class="btn btn-ghost btn-sm status-reaction" href="<?= e(status_url($contentId) . '#status-comments-thread-' . $contentId) ?>" data-modal-open title="<?= et('account.status_comments') ?>">
