...
$assert((int) ($updateResult['deletions'] ?? -1) === 4, 'Patch candidate removes obsolete profile link partials, the email template page and legacy monolithic stylesheet.');
