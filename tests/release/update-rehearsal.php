...
$assert((int) ($updateResult['deletions'] ?? -1) === 11, 'Patch candidate removes obsolete profile link partials, the email template page and split stylesheet files.');
